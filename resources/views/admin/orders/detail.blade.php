...
@section('content')
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                @if($orders[0]['order']['status'] == 'Berhasil')         
                    <button class="btn btn-outline-success" disabled>Disetujui</button>
                    <a href="/dashboard/order-management/taken/{{ $orders[0]['order']['id'] }}"><button class="btn btn-success">Diambil Pelanggan</button></a>
                ...
                @elseif($orders[0]['order']['status'] == 'Dibatalkan')
                    <button class="btn btn-outline-danger" disabled>Dibatalkan Admin</button>
                @elseif($orders[0]['order']['status'] == 'Dibatalkan User')
                    <button class="btn btn-outline-danger" disabled>Dibatalkan User</button>
